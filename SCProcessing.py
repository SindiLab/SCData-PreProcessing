...
# Package methods
from Preprocessing import Preprocess, TrainSplit
...
train_split = TrainSplit(proc_data, opt.trainPercentage, opt.validationPercentage, opt.testPercentage, opt.balancedSplit, opt.randSeed)
